...
function CoupleReconciliation() {
    ...
    const generatePDF = async () => {
        const title = t('coupleReconciliation.title');
        const sections = [
            {
                title: t('coupleReconciliation.subtitle'),
                fields: [
                    { label: t('coupleReconciliation.party1'), value: formData.name1 },
                    { label: t('coupleReconciliation.party2'), value: formData.name2 },
                    { label: "Phone", value: formData.phone },
                    { label: t('coupleReconciliation.email'), value: formData.email },
                    { label: t('coupleReconciliation.date'), value: formData.date },
                    { label: t('coupleReconciliation.time'), value: formatTime12Hour(formData.time) },
                    { label: t('coupleReconciliation.notes'), value: formData.notes },
                ]
            }
        ];
                    ...
                    <div className="col-lg-8">
                        <div className="reservation-card">
                            <div className="reservation-header text-center">
                                <h2 className="section-title">{t('coupleReconciliation.title')}</h2>
                                <p className="section-subtitle">{t('coupleReconciliation.subtitle')}</p>
                            </div>
                                ...
                                <div className="row g-4">
                                    ...
                                    <div className="col-md-6">
                                        <div className="input-group-modern">
                                            <label><FaMale className="me-2" /> {t('coupleReconciliation.party1')}</label>
                                            <input
                                                type="text"
                                                name="name1"
                                                value={formData.name1}
                                                className="form-control-modern"
                                                placeholder={t('coupleReconciliation.enterParty1')}
                                                required
                                    ...
                                    <div className="col-md-6">
                                        <div className="input-group-modern">
                                            <label><FaFemale className="me-2" /> {t('coupleReconciliation.party2')}</label>
                                            <input
                                                type="text"
                                                name="name2"
                                                value={formData.name2}
                                                className="form-control-modern"
                                                placeholder={t('coupleReconciliation.enterParty2')}
                                                required
                                                onChange={handleChange}
                                            />
                                        </div>
                                    ...
                                    <div className="col-md-6">
                                        <div className="input-group-modern">
                                            <label><FaEnvelope className="me-2" /> {t('coupleReconciliation.email')}</label>
                                            <input
                                                type="email"
                                                name="email"
                                                value={formData.email}
                                                className="form-control-modern"
                                                placeholder={t('coupleReconciliation.enterEmail')}
                                                required
                                                onChange={handleChange}
                                            />
                                        </div>
                                    ...
                                    <div className="col-md-6">
                                        <DatePicker
                                            label={t('coupleReconciliation.date')}
                                            value={formData.date}
                                            onChange={handleChange}
                                            name="date"
                                            required
                                    ...
                                    <div className="col-md-6">
                                        <TimePicker
                                            label={t('coupleReconciliation.time')}
                                            value={formData.time}
                                            onChange={handleChange}
                                            name="time"
                                            required
                                    ...
                                    <div className="col-12">
                                        <div className="input-group-modern">
                                            <label>{t('coupleReconciliation.notes')}</label>
                                            <textarea
                                                name="notes"
                                                value={formData.notes}
                                                className="form-control-modern"
                                                rows="3"
                                                placeholder={t('coupleReconciliation.notesPlaceholder')}
                                                onChange={handleChange}
                                            ></textarea>
                                        </div>
                                    </div>
...
export default CoupleReconciliation;
