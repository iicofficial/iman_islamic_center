export const translations = {
    en: {
        ...
        quranBoys: {
            ...
            policy6: "Modest clothing should be worn (thobe, cap or any traditional dress appropriate for religious gatherings for boys. Scarf, abaya or any traditional dress appropriate for religious gatherings for girls)",
    ...
    ar: {
        ...
        quranBoys: {
            ...
            policy6: "يجب ارتداء ملابس محتشمة (ثوب، قبعة أو أي لباس تقليدي مناسب للتجمعات الدينية للأولاد. حجاب، عباءة أو أي لباس تقليدي مناسب للتجمعات الدينية للبنات).",
